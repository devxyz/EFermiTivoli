...
package it.gov.fermitivoli.rss;
...
public class RssHandler extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) {
        ...
        } else if (qName.equals("thumbimage") && rssItem != null) {
            int index = attributes.getIndex("url");
            if (index >= 0) {
                rssItem.setThumbimageLink(attributes.getValue(index));
            }
        } else if (qName.equals("fullimage") && rssItem != null) {
            int index = attributes.getIndex("url");
            if (index >= 0) {
                rssItem.setFullimageLink(attributes.getValue(index));
            }
        }
    }
