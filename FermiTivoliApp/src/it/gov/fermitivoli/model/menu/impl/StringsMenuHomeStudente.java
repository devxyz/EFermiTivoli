...
public class StringsMenuHomeStudente{
     ...
     public static final DataMenuInfo CIRCOLARI_6= new DataMenuInfo(6,"Circolari","Circolari scolastiche",it.gov.fermitivoli.fragment.CircolariSearchFragment.class,R.drawable.file_search,DataMenuInfoType.search(it.gov.fermitivoli.fragment.CircolariSearchFragment.class),null     );
     ...
     public static final DataMenuInfo FERMATE_E_TRAGITTI_AUTOBUS_103= new DataMenuInfo(103,"Fermate e tragitti Autobus","Informazioni autobus Cotral",it.gov.fermitivoli.fragment.CotralFragment.class,R.drawable.bus,DataMenuInfoType.search(it.gov.fermitivoli.fragment.CotralFragment.class),null     );
     ...
     public static final DataMenuInfo ORARI_COTRAL_202= new DataMenuInfo(202,"Orari Cotral","Orari Cotral",it.gov.fermitivoli.action.CotralAction.class,R.drawable.bus,DataMenuInfoType.search(it.gov.fermitivoli.action.CotralAction.class),null     );
}
